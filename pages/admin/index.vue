<template>
  <div class="space-y-6 animate-in fade-in slide-in-from-bottom-5 duration-700">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <!-- Users -->
      <NuxtLink v-if="user?.role === 'admin'" :to="localePath('/admin/users')" class="bg-[#0f3c2e] rounded-[2rem] p-8 text-center text-white shadow-xl shadow-emerald-900/20 hover:scale-[1.03] hover:shadow-2xl transition-all duration-500 group cursor-pointer block relative overflow-hidden">
      ...
      <!-- Messages -->
      <NuxtLink :to="localePath('/admin/contact-us-messages')" class="bg-[#d4a017] rounded-[2rem] p-8 text-center text-white shadow-xl shadow-yellow-900/20 hover:scale-[1.03] hover:shadow-2xl transition-all duration-500 group cursor-pointer block relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        <div class="h-16 w-16 mx-auto bg-white/10 rounded-2xl flex items-center justify-center mb-6 backdrop-blur-md border border-white/10 shadow-inner">
      ...
      <!-- Services -->
      <NuxtLink :to="localePath('/services')" class="bg-[#2563eb] rounded-[2rem] p-8 text-center text-white shadow-xl shadow-blue-900/20 hover:scale-[1.03] hover:shadow-2xl transition-all duration-500 group cursor-pointer block relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        <div class="h-16 w-16 mx-auto bg-white/10 rounded-2xl flex items-center justify-center mb-6 backdrop-blur-md border border-white/10 shadow-inner">
      ...
      <!-- Patient Cases -->
      <NuxtLink :to="localePath('/admin/patient-cases')" class="bg-[#1e293b] rounded-[2rem] p-8 text-center text-white shadow-xl shadow-slate-900/20 hover:scale-[1.03] hover:shadow-2xl transition-all duration-500 group cursor-pointer block relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        <div class="h-16 w-16 mx-auto bg-white/10 rounded-2xl flex items-center justify-center mb-6 backdrop-blur-md border border-white/10 shadow-inner">
      ...
      <!-- Articles -->
      <NuxtLink :to="localePath('/blog')" class="bg-[#475569] rounded-[2rem] p-8 text-center text-white shadow-xl shadow-slate-900/20 hover:scale-[1.03] hover:shadow-2xl transition-all duration-500 group cursor-pointer block relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        <div class="h-16 w-16 mx-auto bg-white/10 rounded-2xl flex items-center justify-center mb-6 backdrop-blur-md border border-white/10 shadow-inner">
      ...
      <!-- Images -->
      <NuxtLink :to="localePath('/gallery')" class="bg-[#8b1a3e] rounded-[2rem] p-8 text-center text-white shadow-xl shadow-rose-900/20 hover:scale-[1.03] hover:shadow-2xl transition-all duration-500 group cursor-pointer block relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        <div class="h-16 w-16 mx-auto bg-white/10 rounded-2xl flex items-center justify-center mb-6 backdrop-blur-md border border-white/10 shadow-inner">
      ...
      <!-- Areas -->
      <NuxtLink :to="localePath('/areas')" class="bg-[#065f46] rounded-[2rem] p-8 text-center text-white shadow-xl shadow-emerald-900/20 hover:scale-[1.03] hover:shadow-2xl transition-all duration-500 group cursor-pointer block relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        <div class="h-16 w-16 mx-auto bg-white/10 rounded-2xl flex items-center justify-center mb-6 backdrop-blur-md border border-white/10 shadow-inner">
      ...
      <!-- Pages -->
      <NuxtLink :to="localePath('/admin/pages')" class="bg-[#6b21a8] rounded-[2rem] p-8 text-center text-white shadow-xl shadow-purple-900/20 hover:scale-[1.03] hover:shadow-2xl transition-all duration-500 group cursor-pointer block relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
        <div class="h-16 w-16 mx-auto bg-white/10 rounded-2xl flex items-center justify-center mb-6 backdrop-blur-md border border-white/10 shadow-inner">
